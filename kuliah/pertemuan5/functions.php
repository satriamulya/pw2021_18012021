...
function login($data)
{
  ...
  if ($user = query("SELECT * FROM user WHERE username = '$username'")) {
    // cek passwordnya
    // password verify kebalikan password hash tadi , dia akan nge bandingin string biasa dengan string yang sudah di acak 
...
function registrasi($data)
{
  ...
  // enkripsi password
  // PASSWORD DEFAULT (random acaknya pake algoritma terbaru untuk passwordnya)
